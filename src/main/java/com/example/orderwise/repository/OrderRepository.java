...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("select o.confirmationDate from Order o where o.stage = :stage order by o.confirmationDate desc limit 1")
    ...
    @Query("select o.deliveredDate from Order o where o.stage = :stage order by o.deliveredDate desc limit 1")
    ...
    @Query("select o.returnDate from Order o where o.stage = :stage order by o.returnDate desc limit 1")
